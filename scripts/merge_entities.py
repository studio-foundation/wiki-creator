...
Runs before alias-resolution (STU-276 pipeline order: merge-entities +
relationship-extraction run first, then alias-resolution reads merge-entities'
output) — resolve-clusters is the only stage that can have already run.
